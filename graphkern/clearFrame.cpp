...
namespace citrus {
	...
	clearFrame::clearFrame(renderSystem& sys, frameStore* fstore) : sysNode(sys), frame(fstore) {
	...
	//}
	//layoutTransition::layoutTransition(renderSystem& sys, frameStore* fstore) : sysNode(sys), frame(fstore) {
	//}
